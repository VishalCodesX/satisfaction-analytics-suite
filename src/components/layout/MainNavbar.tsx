      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-2">
            <Button variant="outline" className="border-sky-blue text-sky-blue hover:bg-sky-blue hover:text-marine-blue">
              Sign In
            </Button>
            <Button className="bg-sky-blue text-marine-blue hover:bg-cream hover:text-marine-blue">
              Get Started
            </Button>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-marine-blue border-t border-steel-blue">
          ...
          <div className="px-2 py-3 border-t border-steel-blue flex flex-col space-y-2">
            <Button variant="outline" className="border-sky-blue text-sky-blue hover:bg-sky-blue hover:text-marine-blue w-full">
              Sign In
            </Button>
            <Button className="bg-sky-blue text-marine-blue hover:bg-cream hover:text-marine-blue w-full">
              Get Started
            </Button>
          </div>
        </div>
